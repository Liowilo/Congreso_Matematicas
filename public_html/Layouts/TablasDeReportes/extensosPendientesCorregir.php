<div id="extensosPendientesCorregir" class="scroll table-responsive border border-success border-opacity-10 rounded pt-2 px-2 pb-5 mt-4" style="max-height: 800px;">
    <table class="table">
        <tr class="head-table">
