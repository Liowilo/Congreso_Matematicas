<div id="extensosPendientesEvaluar" class="scroll table-responsive border border-success border-opacity-10 rounded pt-2 px-2 pb-5 mt-4" style="max-height: 800px;">
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
            <?php
                if(mysqli_fetch_assoc($ejecucionTMPPendienteEvaluar) > 0){
            ...
            <?php
                    ...
                    echo '<td colspan="9"><h5 class="text-center">No se encontraron trabajos pendeintes por evaluar en la etapa <b>'. $etapaTrabajo .'</b></h5></td>';
                }
            ?>
        </tbody>
    </table>
