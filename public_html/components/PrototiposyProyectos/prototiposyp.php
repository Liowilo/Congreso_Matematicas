                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="container cuadricula2 mb-5">
                        <div class="row mt-4 cuadricula">
                            <h2 class="mb-3">Presentación de prototipos robóticos y aplicaciones de IA</h2>
                            <p class="text-description">La exposición de prototipos es una actividad para alumnos en donde se muestran y presentan modelos o versiones preliminares de robots, sistemas de IA, dispositivos o ideas que están en proceso de desarrollo. Estos prototipos pueden variar desde maquetas simples hasta representaciones más avanzadas y funcionales de lo que eventualmente se convertirá en un producto final.</p>
                            <?php 
