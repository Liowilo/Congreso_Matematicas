        ...
        <div class="row registro p-sm-10">
            ...
            <div class="col-md-12 col-lg-5 col-xl-6 formulario_container">
                <div class="my-5 d-flex justify-content align-items-center">
                    ...
                    <img id="rfcInformacion" style="cursor: pointer"
                        class="mx-3 rfcInformacion viewPassword imagenQuestion" src="../../src/question.png" alt=""
                        data-toggle="tooltip" data-placement="right"
                        title="El registro consta de 4 pasos, te encuntras en el 1/4, registrar tus datos personales.">
                </div>
                ...
                <form id="formulario" class="formulario" action="cuenta.php" method="POST">
                    ...
                    <div class="mb-3" id="formulario_grupo_nombres">
                        ...
                        <input type="text" class="form-control" id="nombres" name="nombres" maxlength="90"
                            placeholder="Escribe tus nombres" onkeypress="return validarNombres(event)">
                    ...
                    <div class="mb-3 formulario_grupo">
                        ...
                        <input type="text" class="form-control input" id="apellidos" name="apellidos" maxlength="90"
                            placeholder="Escribe tus apellidos" onkeypress="return validarApellidos(event)">
                    ...
                    <div class="mb-3 formulario_grupo">
                        <label for="correoElectronico" class="form-label" maxlength="90"><span
                                class="text-danger">*</span> Correo Electrónico</label>
                        <input type="text" class="form-control input" id="correoElectronico" name="correoElectronico"
                    ...
                    <div class="mb-3 formulario_grupo">
                        ...
                        <a href="https://www.mi-rfc.com.mx/consulta-rfc-homoclave" target="blank"><img
                                id="rfcInformacion" class="rfcInformacion viewPassword imagenQuestion"
                                src="../../src/question.png" alt="" data-toggle="tooltip" data-placement="right"
                                title="¿No sabes cuál es tu RFC? Consúltalo dando click aquí."></a>
                        <input type="text" class="form-control input" id="rfc" name="rfc" maxlength="30" placeholder=""
                    ...
                    <div class="mb-1 contenedor_link">
                        <label class="form-label link">¿Ya tienes una cuenta?<a class="link_sesion"
                                href="../inicioSesion/sesion.php" disable> Inicia Sesión.</a></label>
                    </div>
                    <!--Grupo Registrate-->
                    <div class="mb-1 div_boton align-items-center justify-content-center">
                        <input type="submit" class="btn btn boton registrate" id="registrate" name="registrate"
                            value="Registrate" disabled>
                    </div>
                    <span class="text-danger">* Campos obligatorios</span>
                    <!--Grupo Volver-->
                    <div class="mt-5" role="group">
                        <a href="#!"><i class="fa fa-chevron-left link" style="font-size: 20px;" aria-hidden="true"
