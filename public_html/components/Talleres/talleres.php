                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="container cuadricula2 mb-5">
                        <div class="row mt-4 cuadricula">
                            ...
                            <p class="text-description">El taller corto se refiere a un par de sesiones o actividad de aprendizaje que tiene una duración limitada en comparación con un curso o taller más extenso. Estos talleres están diseñados para proporcionar información y habilidades específicas de manera concisa y práctica en un período de tiempo más breve. Pueden abordar una variedad de temas, desde habilidades técnicas hasta aspectos más prácticos o creativos. Puedes participar como ponente o asistente.</p>
                            <?php 
