            ...
            <div class="row mt-5">
                <div class="col-lg-8 offset-lg-2">
                    <p class="justified-text reduced-line-height">
                        La Facultad de Estudios Superiores (FES) Cuautitlán, Campus 4, ubicada en Carretera Cuautitlán-Teoloyucan Km. 2.5, San Sebastian Xhala, 54714 Cuautitlán Izcalli, Estado de México, recaba datos personales y es responsable del tratamiento que se les dé.
                    </p>
                    <p class="justified-text reduced-line-height">
                    ...
                    <ul class="reduced-line-height">
                        ...
                        <li>Correo electrónico: Utilizado para comunicaciones relacionadas con el congreso.</li>
                        <li>Número de teléfono: Opcional, para contacto adicional en caso de necesidad.</li>
                        <li>Foto de perfil autógrafa: Para identificación en el perfil del asistente.</li>
                    </ul>
                    <p class="justified-text reduced-line-height">
                        <strong>Finalidades del tratamiento de datos:</strong>
                    </p>
                    <p class="justified-text reduced-line-height">
                        Estos datos serán utilizados con el objetivo de:
                    </p>
                    <ul class="reduced-line-height">
                        ...
                        <li>Contactar a los participantes para comunicaciones relacionadas con el evento.</li>
                        <li>Identificar a los asistentes en el entorno digital del congreso a través de la foto de perfil autografiada.</li>
                    </ul>
                    <p class="justified-text reduced-line-height">
                    ...
                    <p class="justified-text reduced-line-height">
                        <strong>Fecha última actualización:</strong> 07/11/2023
                    </p>
                </div>
            </div>
        </div>
