...
<body>
    ...
    <div class="container mt-5 mb-5">
        <h2 class="mb-3 text-center" style="margin-top: 10px;">AVISO DE PRIVACIDAD DE LA FACULTAD DE ESTUDIOS SUPERIORES CUAUTITLÁN DE LA UNAM</h2>
        <p><br>Tómate un momento para leer el siguiente Aviso de Privacidad en el que informamos, de conformidad con lo dispuesto por el Reglamento de Transparencia, Acceso a la información Pública y Protección de Datos Personales para la Universidad Nacional Autónoma de México (en adelante "LA UNAM"), sobre cómo y con qué fines tratamos tu información personal.</p>
