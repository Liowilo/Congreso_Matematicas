                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="container cuadricula2 mb-5">
                        <div class="row mt-4 cuadricula">
                            <h2 class="mb-3">Ponencias orales</h2>
                            <p class="text-description">Las ponencias sirven para explorar y proporcionar un marco integral que aborde diversos desafíos y oportunidades en el aprendizaje de las matemáticas, con el fin de mejorar la práctica en el aula mediante el intercambio de conocimientos, experiencias y contribuciones en distintas áreas. Este enfoque busca fomentar el avance y la mejora continua de la calidad educativa en el ámbito internacional.</p>
                            <?php 
