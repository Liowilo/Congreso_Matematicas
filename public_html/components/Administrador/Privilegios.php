            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-11 col-sm-12">
                                    ...
                                    <div class="col-sm-3 col-lg-8">
                                        ...
                                        <select id="buscador" name="buscador" class="form-control sm">
                                            ...
                                            while ($fetchUsuario = mysqli_fetch_assoc($resUsuario)) {
                                                ...
                                                ?>
                                                <option value="<?php echo $id_usuario; ?>" name="<?php echo $id_usuario; ?>">
                                                    <?php echo $id_usuario . ' | ' . $apellidosUsuario . ' ' . $nombresUsuario; ?>
                                                </option>
                                                <?php
                                            }
                                            ?>
                        ...
                        <div id="divRoles" class="mt-5 pt-2 px-2 pb-5 border border-success border-opacity-10 rounded"
                            style="max-width:950px; background-color: white">
                            <div class="form-check">
                                <input class="form-check-input m-2 Privilegios" checked="checked" type="radio"
                                    value="roles" name="Privilegios" id="Privilegios">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="card-sm border border-opacity-50 py-3 rounded m-2">
                                        <div class="form-check">
                                            <input class="form-check-input m-1 rol1" type="radio" value="usuarioNormal"
                                                name="rol" id="rol1">
                                            <label class="subTitulo" for="usuarioNormal">Usuario</label>
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item" style="background-color: transparent"
                                                    style="background-color: transparent">11-Inicio de Sesión</li>
                                                <li class="list-group-item" style="background-color: transparent">12-Ver
                                                    sus trabajos</li>
                                                <li class="list-group-item" style="background-color: transparent">13-Ver
                                                    su Historial</li>
                                                <li class="list-group-item" style="background-color: transparent">
                                                    14-Subir trabajo</li>
                                                <li class="list-group-item" style="background-color: transparent">
                                                    15-Solicitar orden de pago</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="card-sm border border-opacity-50 py-3 rounded m-2">
                                        <div class="form-check">
                                            <input class="form-check-input m-1 rol2" type="radio" value="memorias"
                                                name="rol" id="rol2">
                                            <label class="subTitulo" for="memorias">Memorias</label>
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item" style="background-color: transparent">
                                                    11-Inicio de Sesión</li>
                                                <li class="list-group-item" style="background-color: transparent">43-Ver
                                                    todos los registros</li>
                                                <li class="list-group-item" style="background-color: transparent">
                                                    51-Descargar trabajos</li>
                                                <li class="list-group-item" style="background-color: transparent">
                                                    52-Crear Memoria</li>
                                            </ul>
                                        </div>
                                ...
                                <div class="col-sm">
                                    <div class="card-sm border border-opacity-50 py-3 rounded m-2">
                                        <div class="form-check">
                                            <input class="form-check-input m-1 rol3" type="radio" value="evaluador"
                                                name="rol" id="rol3">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item" style="background-color: transparent">
                                                    15-Solicitar orden de pago</li>
                                                <li class="list-group-item" style="background-color: transparent">20-Ser
                                                    evaluador</li>
                                                <li class="list-group-item" style="background-color: transparent">
                                                    21-Evaluar trabajos</li>
                                                <li class="list-group-item" style="background-color: transparent">22-Ver
                                                    historial de sus evaluaciones</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="card-sm border border-opacity-50 py-3 rounded m-2">
                                        <div class="form-check">
                                            <input class="form-check-input m-1 rol4" type="radio" value="administrador1"
                                                name="rol" id="rol4">
                                            <label class="subTitulo" for="administrador1">Administrador
                                                1</label><!--Web Master--->
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item" style="background-color: transparent">
                                                    11-Inicio de Sesión</li>
                                                ...
                                                <li class="list-group-item" style="background-color: transparent">22-Ver
                                                    historial de sus evaluaciones</li>
                                                <li class="list-group-item" style="background-color: transparent">31-Ver
                                                    registro de pago</li>
                                                <li class="list-group-item" style="background-color: transparent">
                                                    41-Asignar evaluador</li>
                                                <li class="list-group-item" style="background-color: transparent">
                                                    42-Cambiar Privilegios</li>
                                                <li class="list-group-item" style="background-color: transparent">43-Ver
                                                    reportes</li>
                                                <li class="list-group-item" style="background-color: transparent">
                                                    44-Crear Congreso</li>
                                                <li class="list-group-item" style="background-color: transparent">
                                                    51-Descargar trabajos</li>
                                                <li class="list-group-item" style="background-color: transparent">
                                                    52-Crear Memoria</li>
                                ...
                                <div class="col-sm-4">
                                    <div class="card-sm border border-opacity-50 py-3 rounded m-2">
                                        <div class="form-check">
                                            <input class="form-check-input m-1 rol5" type="radio" value="administrador2"
                                                name="rol" id="rol5">
                        ...
                        <div id="divFunciones"
                            class="mt-5 pt-2 px-2 pb-5 border border-success border-opacity-10 rounded"
                            style="max-width:950px; background-color:#D9D9D9">
                            <div class="form-check">
                                <input class="form-check-input m-2 Privilegios" value="funcion" type="radio"
                                    name="Privilegios" id="Privilegios">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input class="form-check-input" type="checkbox" value="1" id="11"
                                                    name="11" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="fila" scope="row">12-Ver sus trabajos</th>
                                            <td><input class="form-check-input" type="checkbox" value="1" id="12"
                                                    name="12" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="fila" scope="row">13-Ver su Historial</th>
                                            <td><input class="form-check-input" type="checkbox" value="1" id="13"
                                                    name="13" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="fila" scope="row">14-Subir trabajo</th>
                                            <td><input class="form-check-input" type="checkbox" value="1" id="14"
                                                    name="14" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="fila" scope="row">15-Solicitar orden de pago</th>
                                            <td><input class="form-check-input" type="checkbox" value="1" id="15"
                                                    name="15" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="fila" scope="row">20-Ser evaluador</th>
                                            <td><input class="form-check-input" type="checkbox" value="1" id="20"
                                                    name="20" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="fila" scope="row">21-Evaluar trabajos</th>
                                            <td><input class="form-check-input" type="checkbox" value="1" id="21"
                                                    name="21" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="fila" scope="row">22-Ver historial de sus evaluaciones</th>
                                            <td><input class="form-check-input" type="checkbox" value="1" id="22"
                                                    name="22" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="fila" scope="row">31-Ver registro de pago</th>
                                            <td><input class="form-check-input" type="checkbox" value="1" id="31"
                                                    name="31" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="fila" scope="row">41-Asignar evaluador</th>
                                            <td><input class="form-check-input" type="checkbox" value="1" id="41"
                                                    name="41" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="fila" scope="row">42-Cambiar Privilegios</th>
                                            <td><input class="form-check-input" type="checkbox" value="1" id="42"
                                                    name="42" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="fila" scope="row">43-Ver reportes</th>
                                            <td><input class="form-check-input" type="checkbox" value="1" id="43"
                                                    name="43" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="fila" scope="row">44-Crear Congreso</th>
                                            <td><input class="form-check-input" type="checkbox" value="1" id="44"
                                                    name="44" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="fila" scope="row">51-Descargar trabajos</th>
                                            <td><input class="form-check-input" type="checkbox" value="1" id="51"
                                                    name="51" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="fila" scope="row">52-Crear Memoria</th>
                                            <td><input class="form-check-input" type="checkbox" value="1" id="52"
                                                    name="52" disabled></td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="m-3">
                            <input class="btn btn-style block px-4 mx-2" value="Guardar" type="submit" id="actualizar"
                                name="actualizar">
                        </div>
                    </form>
                    <!----------------------------------------------------------------------------------------------->
