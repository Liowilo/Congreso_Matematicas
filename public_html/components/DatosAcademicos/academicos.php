                ...
                <div class="container">
                    ...
                    if ($estadoUsuario == '') {
                        ...
                        <div class="my-5 d-flex justify-content align-items-center">
                            ...
                            <img id="rfcInformacion" style="cursor: pointer; width: 25px; height: 25px;"
                                ...
                                title="El registro consta de 4 pasos, te encuentras en el 3/4, registrar tus datos academicos.">
                        </div>
                        <?php
                    }
                    ?>
                    ...
                    <div class="row mt-3 ">
                        <div class="col-lg-6 col-md-6">
                            ...
                            <form method="POST">
                                <select id="selectNivelAcademico" name="selectNivelAcademico"
                                    class="form-select texto-academicos fw-semibold"
                                    ...
                                    while ($fetch = mysqli_fetch_assoc($resDatosAcademicos)) {
                                        ...
                                        if ($nivelAcademicoUsuario == $idNivelAcademico) {
                                            ...
                                            ?>
                                            <option selected value="<?php echo $idNivelAcademico ?>"
                                                id="<?php echo $idNivelAcademico ?>" name="<?php echo $idNivelAcademico ?>">
                                                <?php echo $nivelAcademico ?>
                                            </option>
                                        <?php } else {
                                            ?>
                                            <option value="<?php echo $idNivelAcademico ?>" id="<?php echo $idNivelAcademico ?>"
                                                name="<?php echo $idNivelAcademico ?>">
                                                <?php echo $nivelAcademico ?>
                                            </option>
                                            <?php
                                        }
                                ...
                                <input class="btn btn-style-chico shadow mt-3" type="submit"
                                    name="botonGuardarDatosAcademicos" id="botonGuardarDatosAcademicos" value="Guardar">
                            </form>
                        </div>
                    ...
                    <div class="row mt-3 ">
                        <div class="col-lg-6">
                            <span class="texto-academicos">Este resumen se mostrará como presentación para cada
                                panelista, asegúrate de incluir: logros académicos, laborales, participaciones en
                                congresos anteriores y estudios complementarios.</span><br><br>
                                ...
                                <div class="col-lg-7 mb-2">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="d-grid gap-2">
                                            <input type="file" class="form-control" name="inputSemblanza"
                                                id="inputSemblanza">
                                        ...
                                        <div class="col-lg-5 d-grid gap-2 mt-3">
                                            <input id="subirSemblanza" name="subirSemblanza"
                                                class="btn btn-style-chico shadow p-1" type="submit" value="Subir"
