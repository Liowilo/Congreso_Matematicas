                ...
                <div class="container">
                    ...
                    if (mysqli_num_rows($resTrabajosRegistrados) > 0 || mysqli_num_rows($resTrabajosRegistradosCoautor) > 0) {
                        ...
                        <div class="containerConR" id="containerConR">
                            ...
                            <div class="row mt-4">
                                <p id="infoNoMasTrabajos" class="mt-5 text-center lead ">Ya no tienes más trabajos por
                                    el momento.</p>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4 mt-5">
                                    <div class="col-lg-5 d-grid gap-2 mt-5 mb-5">
                                        <a href="../../components/subirResumen/subirResumen.php"
                                            class="btn btn-style-chico shadow p-1 MT-4">Participa</a>
                                    </div>
                                </div>
