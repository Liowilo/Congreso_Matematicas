            ...
            <div class="col-xl-9 col-lg-9 col-md-11 col-sm-12">
                <div class="container">
                    ...
                    <div class="d-flex flex-row-reverse col-10 mt-4">
                        <a href="../../src/GuiasYPlantillas/Guia_para_autores_2023.pdf" target="_blank"
                            class="botones_descarga shadow py-1 px-5 mb-5 text-wrap"><button class="btn text-btn"
                                type="button">Descargar Guia</button></a>
                    </div>
                    <h4 class="mt-4">Plantilla de trabajos extensos</h4>
                    <span class="texto-sm">Los trabajos extensos deberán redactarse basándose en la plantilla de
                        trabajos extensos.
                    ...
                    <div class="d-flex flex-row-reverse col-10 mt-4">
                        <a href="../../src/GuiasYPlantillas/Plantilla_extenso_2023.docx"
                            download="Plantilla_extenso_2023"
                            class="botones_descarga shadow py-1 px-5 mb-5 text-wrap"><button class="btn text-btn"
                                type="button">Descargar Plantilla</button></a>
                    </div>
                </div>
            </div><!--container-->
        </div><!--col-10-->
