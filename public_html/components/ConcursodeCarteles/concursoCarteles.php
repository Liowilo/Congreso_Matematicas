                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="container cuadricula2 mb-5">
                        <div class="row mt-4 cuadricula">
                            <h2 class="mb-3">Concurso de carteles</h2>
                            <p class="text-description">El concurso de carteles es una forma efectiva de comunicar y compartir investigaciones o proyectos de manera visual, fomentando la interacción y la retroalimentación entre los participantes del evento. El comité evaluador de carteles evalúa los trabajos presentados y con base en los elementos de evaluación determinados premia a los carteles que obtengan las tres máximas puntuaciones.</p>
                            <?php 
