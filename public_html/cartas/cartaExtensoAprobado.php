<?php
  ...
  $pdf->Text(10,68,utf8_decode('Categoría:'));
  ...
  $pdf->Text(10,160,utf8_decode('Es necesario subir el enlace del vídeo de la presentación de la ponencia al correo del congreso: '));
  $pdf->Text(10,165,utf8_decode(strtolower($correoCongreso)));
  ...
  $pdf->Text(10,170,utf8_decode('El vídeo debe ser cargado en la nube mediante plataformas como Google Drive, OneDrive u otro servicio de preferencia. '));
  $pdf->Text(10,175,utf8_decode('Favor de asegurarse de configurar el vídeo para que sea accesible a través del enlace proporcionado.'));
  $pdf->Text(10,185,utf8_decode('Consulte las características del vídeo en el menú del sitio.'));
  $pdf->Text(10,190,utf8_decode('https://congresomatematicas.cuautitlan2.unam.mx/components/GuiasYPlantillas/guias.php'));
 
  $pdf->Text(10,200,utf8_decode('Le informamos que su extenso pudiera tener ajustes en el diseño para integrarlo en las memorias. '));
  $pdf->Text(10,205,utf8_decode('Las memorias serán publicadas cuatro semanas después de terminado el evento.'));
  $pdf->Text(10,210,utf8_decode('Recuerde realizar el pago correspondiente para que su trabajo sea incluido en las memorias del congreso.'));
  
  $pdf->Text(10,220,utf8_decode('Sin más por el momento, quedamos de usted.'));
  $pdf->Text(10,230,utf8_decode('Atentamente'));
  $pdf->Text(10,235,utf8_decode('"Por mi Raza Hablará el Espíritu"'));
  
 
  $pdf->Text(72,245,utf8_decode('El Comité Organizador'));
