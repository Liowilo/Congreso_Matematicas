...
require "traerCongresoActual.php";
    ...
    **/
    ...
    $consPonenciasRegistradasCoautor = "SELECT count(*) FROM usuario_colabora_ponencia_18012024
    INNER JOIN ponencia ON usuario_colabora_ponencia_18012024.id_ponencia=ponencia.id_ponencia
    WHERE usuario_colabora_ponencia_18012024.id_usuario='$_SESSION[id]' AND usuario_colabora_ponencia_18012024.id_congreso='$idCongreso'";
    ...
    //Carteles
    $consNumeroCartelesRegistradosCoautor = "SELECT count(*) FROM usuario_colabora_ponencia_18012024
    INNER JOIN ponencia ON usuario_colabora_ponencia_18012024.id_ponencia=ponencia.id_ponencia
    WHERE usuario_colabora_ponencia_18012024.id_usuario='$_SESSION[id]' AND usuario_colabora_ponencia_18012024.id_congreso='$idCongreso' AND ponencia.id_tipo_ponencia='1'";
    ...
    //Ponencias
    $consNumeroPonenciasRegistradasCoautor = "SELECT count(*) FROM usuario_colabora_ponencia_18012024
    INNER JOIN ponencia ON usuario_colabora_ponencia_18012024.id_ponencia=ponencia.id_ponencia
    WHERE usuario_colabora_ponencia_18012024.id_usuario='$_SESSION[id]' AND usuario_colabora_ponencia_18012024.id_congreso='$idCongreso' AND ponencia.id_tipo_ponencia='2'";
    ...
    //Talleres
    $consNumeroTalleresRegistradosCoautor = "SELECT count(*) FROM usuario_colabora_ponencia_18012024
    INNER JOIN ponencia ON usuario_colabora_ponencia_18012024.id_ponencia=ponencia.id_ponencia
    WHERE usuario_colabora_ponencia_18012024.id_usuario='$_SESSION[id]' AND usuario_colabora_ponencia_18012024.id_congreso='$idCongreso' AND ponencia.id_tipo_ponencia='3'";
    ...
    //Prototipo
    $consNumeroPrototiposRegistradosCoautor = "SELECT count(*) FROM usuario_colabora_ponencia_18012024
    INNER JOIN ponencia ON usuario_colabora_ponencia_18012024.id_ponencia=ponencia.id_ponencia
    WHERE usuario_colabora_ponencia_18012024.id_usuario='$_SESSION[id]' AND usuario_colabora_ponencia_18012024.id_congreso='$idCongreso' AND ponencia.id_tipo_ponencia='3'";
