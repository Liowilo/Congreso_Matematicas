...
require "traerCongresoActual.php";
    ...
    **/
    ...
    WHERE usuario_colabora_ponencia.id_usuario='$_SESSION[id]' AND usuario_colabora_ponencia.id_congreso='$idCongreso'";
    ...
    INNER JOIN ponencia ON usuario_colabora_ponencia.id_ponencia=ponencia.id_ponencia
    WHERE usuario_colabora_ponencia.id_usuario='$_SESSION[id]' AND usuario_colabora_ponencia.id_congreso='$idCongreso' AND ponencia.id_tipo_ponencia='1'";
    ...
    INNER JOIN ponencia ON usuario_colabora_ponencia.id_ponencia=ponencia.id_ponencia
    WHERE usuario_colabora_ponencia.id_usuario='$_SESSION[id]' AND usuario_colabora_ponencia.id_congreso='$idCongreso' AND ponencia.id_tipo_ponencia='2'";
    ...
    INNER JOIN ponencia ON usuario_colabora_ponencia.id_ponencia=ponencia.id_ponencia
    WHERE usuario_colabora_ponencia.id_usuario='$_SESSION[id]' AND usuario_colabora_ponencia.id_congreso='$idCongreso' AND ponencia.id_tipo_ponencia='3'";
