...
require "traerCongresoActual.php";
    ...
    **/ 
    ...
    $consNumeroCartelesCongreso = "SELECT MAX(id_ponencia) AS max_id FROM ponencia WHERE id_congreso='$idCongreso'";
    ...
    $numeroCartelesCongreso = (int)substr("$idPonenciaCartel", 4,-2) + 1;
    
    //Consulta el número de ponencias orales del congreso
    
    $consNumeroPonenciasCongreso = "SELECT MAX(id_ponencia) AS max_id FROM ponencia WHERE id_congreso='$idCongreso'";
    ...
    $numeroPonenciasCongreso = (int)substr("$idPonenciaOral", 4,-2) + 1;
    
    //Consulta el número de talleres del congreso

    $consNumeroTalleresCongreso = "SELECT MAX(id_ponencia) AS max_id FROM ponencia WHERE id_congreso='$idCongreso'";
    ...
    $numeroTalleresCongreso = (int)substr("$idPonenciaTaller", 4,-2) + 1;
   
    //Consulta el número de prototipos del congreso

    $consNumeroPrototiposCongreso = "SELECT MAX(id_ponencia) AS max_id FROM ponencia WHERE id_congreso='$idCongreso'";
    ...
    $numeroPrototiposCongreso = (int)substr("$idPonenciaPrototipo", 4,-2) + 1;
    /** 
    *******************************************************************************************************
    *******************************************************************************************************
    **/    
